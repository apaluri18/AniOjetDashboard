 ...
 */
define(['knockout', 'ojs/ojmodule-element-utils', 'ojs/ojknockouttemplateutils', 'ojs/ojrouter'
, 'ojs/ojresponsiveutils', 'ojs/ojresponsiveknockoututils'
, 'ojs/ojarraydataprovider',
        'ojs/ojoffcanvas', 'ojs/ojmodule-element', 'ojs/ojknockout','ojs/ojnavigationlist'],
  function(ko, moduleUtils, KnockoutTemplateUtils, Router, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils) {
     function ControllerViewModel() {
      ...
      self.mdScreen = ResponsiveKnockoutUtils.createMediaQueryObservable(mdQuery);
       ...
       self.router.configure({
        'home': {label: 'Home', isDefault: true},
         'ordercreate': {label: 'ordercreate'},
         'orderevents': {label: 'orderevents'},
         'linemapping': {label: 'linemapping'},
         'ratecard': {label: 'ratecard'},
         'optiers': {label: 'optiers'},
         'gsimapping': {label: 'gsimapping'},
      ...
      {name: 'Order Creation', id: 'ordercreate',
      iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-fire-icon-24'},
        {name: 'Events', id: 'orderevents',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-fire-icon-24'},
      {name: 'Line Mapping', id: 'linemapping',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-library-icon-24'},
      {name: 'Rate Cards', id: 'ratecard',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-copy-icon-24'},
       {name: 'Option Tiers', id: 'optiers',
       iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-copy-icon-24'},
       {name: 'GSI Mapping', id: 'gsimapping',
      ...
      self.appName = ko.observable("Fusion Order Management Dashboard");
